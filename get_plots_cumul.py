...
df_gcsl_n = pd.read_csv('data/example/door/gcsl_mt2_sto_1/2022_01_08_10_53_34/progress.csv')
df_gcsl = pd.read_csv('data/example/door/gcsl_od/2021_12_24_09_55_33/progress.csv')
df_gcsl_s = pd.read_csv('data/example/door/gcsl_o_1/2022_01_09_12_17_55/progress.csv')
'''''
#'''''
#pusher
df_gcsl_nt = pd.read_csv('data/example/pusher/gcsl_mt2/2022_01_04_10_18_53/progress.csv')
df_gcsl_n = pd.read_csv('data/example/pusher/gcsl_mt2_sto_1/2022_01_08_10_53_34/progress.csv')
df_gcsl = pd.read_csv('data/example/pusher/gcsl_od/2021_12_24_09_55_32/progress.csv')
df_gcsl_s = pd.read_csv('data/example/pusher/gcsl_o_1/2022_01_09_12_17_55/progress.csv')
#'''''
'''''
#lunar
...
df_gcsl_n_1 = pd.read_csv('data/example/door/gcsl_mt2_sto_1/2022_01_08_14_22_50/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/door/gcsl_od/2021_12_24_12_09_27/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/door/gcsl_o_1/2022_01_09_14_48_14/progress.csv')
'''''
#'''''
#pusher
df_gcsl_nt_1 = pd.read_csv('data/example/pusher/gcsl_mt2/2022_01_05_00_00_28/progress.csv')
df_gcsl_n_1 = pd.read_csv('data/example/pusher/gcsl_mt2_sto_1/2022_01_08_14_22_49/progress.csv')
df_gcsl_1 = pd.read_csv('data/example/pusher/gcsl_od/2021_12_24_12_09_27/progress.csv')
df_gcsl_s_1 = pd.read_csv('data/example/pusher/gcsl_o_1/2022_01_09_14_48_13/progress.csv')
#'''''
'''''
#lunar
...
df_gcsl_n_2 = pd.read_csv('data/example/door/gcsl_mt2_sto_1/2022_01_08_17_51_32/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/door/gcsl_od/2021_12_24_14_27_57/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/door/gcsl_o_1/2022_01_09_17_21_25/progress.csv')
'''''
#'''''
#pusher
df_gcsl_nt_2 = pd.read_csv('data/example/pusher/gcsl_mt2/2022_01_05_03_34_59/progress.csv')
df_gcsl_n_2 = pd.read_csv('data/example/pusher/gcsl_mt2_sto_1/2022_01_08_17_51_31/progress.csv')
df_gcsl_2 = pd.read_csv('data/example/pusher/gcsl_od/2021_12_24_14_27_56/progress.csv')
df_gcsl_s_2 = pd.read_csv('data/example/pusher/gcsl_o_1/2022_01_09_17_21_24/progress.csv')
#'''''
'''''
#lunar
...
plt.grid()
plt.show()
#plt.savefig('plots_new/'+env+'_s2/success.jpg')
plt.close()
...
plt.grid()
#plt.show()
#plt.savefig('plots_new/'+env+'_s2/avg_dist.jpg')
plt.close()
...
plt.grid()
#plt.show()
#plt.savefig('plots_new/'+env+'_s2/loss.jpg')
plt.close()
